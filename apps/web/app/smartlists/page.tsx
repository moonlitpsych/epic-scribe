      ...
      <div className="bg-[var(--bg-surface)] border-b border-[var(--border-default)] px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[var(--text-primary)]">SmartList Manager</h1>
              <p className="text-sm text-[var(--text-secondary)]">Manage Epic SmartList options and configurations</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 text-white rounded flex items-center gap-2 text-sm font-medium transition-all duration-200"
              style={{
