  ...
  return (
    <div className="min-h-screen bg-[var(--bg-surface-2)]">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-[var(--bg-surface)] rounded-[2px] p-6">
            ...
            <textarea
              ...
              className="w-full h-96 p-3 border border-[var(--border-default)] rounded bg-[var(--bg-surface-2)] text-[var(--text-primary)] placeholder:text-[var(--text-muted)] font-mono text-sm"
              placeholder="Paste or type transcript here..."
            />

            <div className="mt-4 space-y-3">
              <div className="flex items-center space-x-4">
                <label className="text-sm font-medium text-[var(--text-primary)]">Visit Type:</label>
                <select
                  value={visitType}
                  onChange={(e) => setVisitType(e.target.value as 'Intake' | 'Follow-up')}
                  className="px-3 py-1 border border-[var(--border-default)] rounded text-sm bg-[var(--bg-surface-2)] text-[var(--text-primary)]"
                >
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[var(--accent-primary)] text-[var(--text-inverse)] rounded hover:bg-[var(--accent-primary-hover)] disabled:bg-[var(--bg-hover)] disabled:cursor-not-allowed"
                >
            ...
            {error && (
              <div className="mt-4 p-3 bg-[var(--error-bg)] border border-[var(--error-border)] rounded">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              {generatedNote && (
                <button
                  ...
                  className="px-3 py-1 text-sm bg-[var(--bg-surface-2)] text-[var(--text-primary)] rounded hover:bg-[var(--bg-hover)]"
                >
                  Copy
                </button>
              )}
        ...
        {/* Key Features */}
        <div className="mt-8 bg-[var(--info-bg)] rounded-[2px] p-6">
          <h3 className="text-lg font-semibold text-[var(--info-text)] mb-3">
            Key Features of Focused Psychiatric Notes
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-[var(--info-text)]">
            <div>
